...
const COMMANDS: Array<{
  ...
  { id: "go-notes", label: "Open Notes", group: "Navigate", section: "notes", icon: <StickyNote style={iconStyle} /> },
  { id: "go-vault", label: "Open Vault", group: "Navigate", section: "vault", icon: <LockKeyhole style={iconStyle} /> },
